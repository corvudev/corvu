...
const Topbar: ParentComponent<{
  ...
  return (
    <header
      class="fixed inset-x-0 top-0 z-30 lg:pointer-events-none"
      style={{
    ...
    >
      ...
      >
        <a href="/" class="lg:pointer-events-auto">
        ...
        <div class="flex items-center space-x-2 lg:pointer-events-auto">
          <ThemeSelect />
          <a
