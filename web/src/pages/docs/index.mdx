...
## Features
### Unstyled
Primitives do not provide any styling, allowing you to bring your own and style them according to your preferences or style guidelines. You can use TailwindCSS, any CSS-in-JS library or plain old CSS to style it. We provide plugins for [TailwindCSS](/docs/styling/#tailwindcss-plugin) and [UnoCSS](/docs/styling/#unocss-preset) that make it easy to style components based on their current state. Read more in [Styling](/docs/styling/).
