...
title: Managing the state of corvu UI primitives
description: Learn how to manage the state of SolidJS corvu UI primitives.
...
The `Root` component of every primitive also accepts a function as its children. By doing this, we can pass the internal state to the children for you to access. An example of this looks like this:
